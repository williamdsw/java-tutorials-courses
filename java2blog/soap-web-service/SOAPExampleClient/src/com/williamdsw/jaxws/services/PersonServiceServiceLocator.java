...
public class PersonServiceServiceLocator extends org.apache.axis.client.Service
        implements com.williamdsw.jaxws.services.PersonServiceService {
    ...
    public PersonServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
    ...
    public com.williamdsw.jaxws.services.PersonService getPersonService(java.net.URL portAddress)
            throws javax.xml.rpc.ServiceException {
        try {
            com.williamdsw.jaxws.services.PersonServiceSoapBindingStub _stub = new com.williamdsw.jaxws.services.PersonServiceSoapBindingStub(
                    portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.williamdsw.jaxws.services.PersonService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.williamdsw.jaxws.services.PersonServiceSoapBindingStub _stub = new com.williamdsw.jaxws.services.PersonServiceSoapBindingStub(
                        new java.net.URL(PersonService_address), this);
                _stub.setPortName(getPersonServiceWSDDServiceName());
                return _stub;
            }
