...
public class StudentControllerIntegrationTest {
	...
	public void testRetrieveStudentCourse() throws JSONException {
		...
		ResponseEntity<String> response = restTemplate.exchange(createURLWithPort(RETRIEVE_STUDENT_COURSE_URL),
	...
	public void testAddCourse() {
		...
		ResponseEntity<String> response = restTemplate.exchange(createURLWithPort(ADD_COURSE_URL), HttpMethod.POST,
				entity, String.class);
