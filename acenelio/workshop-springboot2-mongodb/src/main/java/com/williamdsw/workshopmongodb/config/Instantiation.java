...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post2 = new Post(null, dateFormat.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!",
                new AuthorDTO(maria));
        ...
        CommentDTO comment3 = new CommentDTO("Tenha um ótimo dia!", dateFormat.parse("23/03/2018"),
                new AuthorDTO(alex));
